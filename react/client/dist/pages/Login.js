...
function Login(props) {
  ...
  var handleSubmit = function handleSubmit(e) {
    e.preventDefault();
    setLoading(true);
    (0, _ajax.login)(formProp).then( /*#__PURE__*/function () {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                token = res.token, payload = res.payload;
                _context.next = 3;
                return (0, _jwt.setAuthToken)(token);

              case 3:
                setTimeout(function () {
                  dispatch((0, _user.onLogin)(payload));
                  setRedirect(true);
                }, 500);
  ...
  return /*#__PURE__*/_react.default.createElement("div", null, redirect ? /*#__PURE__*/_react.default.createElement(_reactRouter.Redirect, {
    to: {
      pathname: "/",
      state: {
        toast: _toast.LOGIN_SUCCESSFULL
      }
    }
  ...
  }, /*#__PURE__*/_react.default.createElement("h4", null, "Login")), /*#__PURE__*/_react.default.createElement(_CardBody.default, null, /*#__PURE__*/_react.default.createElement(_CustomInput.default, {
    labelText: "Email...",
    id: "email",
