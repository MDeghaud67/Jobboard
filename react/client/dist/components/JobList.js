...
var _JobItem = _interopRequireDefault(require("./JobItem"));
...
var JobList = function JobList() {
  ...
  (0, _react.useEffect)(function () {
    (0, _ajax.getJobs)().then(function (res) {
      setJobs(res);
    }).catch(function (err) {
      console.log(err);
    });
  ...
  }, "Recent jobs"), /*#__PURE__*/_react.default.createElement(_GridContainer.default, null, jobs.map(function (job, i) {
